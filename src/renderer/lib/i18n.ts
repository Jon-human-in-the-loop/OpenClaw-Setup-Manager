...
const translations = {
  ...
  "systemcheck.docker": { es: "Docker", en: "Docker" },
  "systemcheck.docker.ok": { es: "Docker {version} corriendo", en: "Docker {version} running" },
  "systemcheck.docker.installed_not_running": { es: "Docker instalado pero daemon no activo", en: "Docker installed but daemon not running" },
  "systemcheck.docker.missing": { es: "Docker no encontrado", en: "Docker not found" },
  ...
  "systemcheck.fix.docker": { es: "Instala Docker Desktop desde docker.com", en: "Install Docker Desktop from docker.com" },
  "systemcheck.fix.docker.notrunning": { es: "Abre Docker Desktop y espera a que inicie. Luego haz clic en 'Corregir y volver a verificar'.", en: "Open Docker Desktop and wait for it to start. Then click 'Fix and re-check'." },
  ...
  "credentials.telegram.userid.label": { es: "Tu ID de Usuario de Telegram", en: "Your Telegram User ID" },
  "credentials.telegram.userid.placeholder": { es: "123456789", en: "123456789" },
  "credentials.telegram.userid.hint": { es: "Solo este ID podrá enviarle mensajes al bot. Usa @userinfobot para obtenerlo.", en: "Only this ID can send messages to the bot. Use @userinfobot to find yours." },
  ...
  "credentials.discord.userid.label": { es: "Tu ID de Usuario de Discord", en: "Your Discord User ID" },
  "credentials.discord.userid.placeholder": { es: "123456789012345678", en: "123456789012345678" },
  "credentials.discord.userid.hint": { es: "Solo este ID podrá enviarle DMs al bot. Activa Modo Desarrollador en Discord para verlo.", en: "Only this ID can DM the bot. Enable Developer Mode in Discord to see it." },
